...
pdf("UMPUplot.pdf",width=7,height=4)
plot(values,phi,type="l",lty=2,col="red",lwd=thick,xlab="x",ylab="test")
...
legend("topright",lty=c(2,4),col=c("red","blue"),c("alpha=.1","alpha=.01"),lwd=thick)
dev.off()
